...
- [nextcloud/desktop](https://github.com/nextcloud/desktop) ([v3.2.3](https://github.com/nextcloud/desktop/releases/tag/v3.2.3), today) - 💻 Desktop sync client for Nextcloud
- [GitGuardian/gg-shield](https://github.com/GitGuardian/gg-shield) ([v1.6.1](https://github.com/GitGuardian/gg-shield/releases/tag/v1.6.1), 2 days ago) - Detect secret in source code, scan your repo for leaks. Find secrets with GitGuardian and prevent leaked credentials. GitGuardian is an automated secrets detection &amp; remediation service.
...
- [Web Review, Week 2021-21](https://ervin.ipsquad.net/blog/2021/05/28/web-review-week-2021-21/) (4 weeks ago)
