...
- [GitGuardian/ggshield](https://github.com/GitGuardian/ggshield) ([v1.10.1](https://github.com/GitGuardian/ggshield/releases/tag/v1.10.1), 1 day ago) - Detect secret in source code, scan your repo for leaks. Find secrets with GitGuardian and prevent leaked credentials. GitGuardian is an automated secrets detection &amp; remediation service.
- [nextcloud/desktop](https://github.com/nextcloud/desktop) ([v3.3.6](https://github.com/nextcloud/desktop/releases/tag/v3.3.6), 2 days ago) - 💻 Desktop sync client for Nextcloud
...
- [Web Review, Week 2021-43](https://ervin.ipsquad.net/blog/2021/10/29/web-review-week-2021-43/) (1 day ago)
