...
- [nextcloud/desktop](https://github.com/nextcloud/desktop) ([v3.4.0-rc1](https://github.com/nextcloud/desktop/releases/tag/v3.4.0-rc1), today) - 💻 Desktop sync client for Nextcloud
- [GitGuardian/ggshield](https://github.com/GitGuardian/ggshield) ([v1.10.4](https://github.com/GitGuardian/ggshield/releases/tag/v1.10.4), 6 days ago) - Detect secret in source code, scan your repo for leaks. Find secrets with GitGuardian and prevent leaked credentials. GitGuardian is an automated secrets detection &amp; remediation service.
...
- [Web Review, Week 2021-44](https://ervin.ipsquad.net/blog/2021/11/05/web-review-week-2021-44/) (6 days ago)
